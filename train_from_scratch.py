...
def training_validating_testing(args, classifier, criterion, optimizer, scheduler, trainloader, valloader, testloader):
    # 开始训练
...
def main(args):
    ...
    training_validating_testing(args, classifier, criterion, optimizer, scheduler, trainloader, valloader, testloader)
